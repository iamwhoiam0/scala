...
object Maps {
  ...
  def main(args: Array[String]): Unit = {
    print("testGroupUsers(Seq(User(\"Nikita\", 25), User(\"Artem\", 24), User(\"Artem\", 19), User(\"Nikita\", 20), User(\"Nikita\", 18))) = " +
      testGroupUsers(Seq(User("Nikita", 34), User("Artem", 23), User("Artem", 19), User("Nikita", 20), User("Nikita", 18))))
