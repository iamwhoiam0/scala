...
object Compositions {
  ...
  def main(args: Array[String]): Unit = {
    print("testCompose((x: Int) => x * 2)((x: Int) => x + 1)((x: Int) => x * x)(3) = " +
      testCompose((x: Int) => x * 2)((x: Int) => x + 1)((x: Int) => x * x)(3))

    print("\n\ntestMapFlatMap((x: Int) => Some(x * 2))((x: Int) => Some(x + 1))((x: Int) => x * x)(Some(3)) = " +
      testMapFlatMap((x: Int) => Some(x * 2))((x: Int) => Some(x + 1))((x: Int) => x * x)(Some(3)))

    print("\ntestMapFlatMap((x: Int) => Some(x * 2))((_: Int) => None())((x: Int) => x * x)(Some(3)) = " +
      testMapFlatMap((x: Int) => Some(x * 2))((_: Int) => None())((x: Int) => x * x)(Some(3)))

    print("\n\ntestForComprehension((x: Int) => Some(x * 2))((x: Int) => Some(x + 1))((x: Int) => x * x)(Some(3)) = " +
      testForComprehension((x: Int) => Some(x * 2))((x: Int) => Some(x + 1))((x: Int) => x * x)(Some(3)))

    print("\ntestForComprehension((x: Int) => Some(x * 2))((_: Int) => None())((x: Int) => x * x)(Some(3)) = " +
      testForComprehension((x: Int) => Some(x * 2))((_: Int) => None())((x: Int) => x * x)(Some(3)))
  }
}
